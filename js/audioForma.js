...
const listaPistas = [
  {
    titulo: "Bad",
    archivo: "./src/podcasts/formación/David Guetta _ Showtek - Bad ft.Vassy (Lyrics Video)(MP3_320K).mp3",
  ...
  },
  {
    titulo: "TSUNAMI",
    archivo:
      "./src/podcasts/formación/DVBBS _ Borgeous - TSUNAMI (Original Mix)(MP3_320K).mp3",
  ...
  {
    titulo: "tremor",
    archivo: "./src/podcasts/formación/Martin garrix tremor (original mix)(MP3_320K).mp3",
